...
class Select:
    ...
    def environ(self, env_type):
        ...
        if env_type == 'conda':
            from blocks.packages.environ._conda import CondaEnv
            env_type = CondaEnv
        elif env_type == 'venv':
            from blocks.packages.environ._venv import VenvEnv
            env_type = VenvEnv
    ...
    def manager(self, manager):
        ...
        if manager == 'pip':
            from blocks.packages.manager._pip import PipManager
            manager = PipManager
        elif manager == 'conda':
            from blocks.packages.manager._conda import CondaManager
