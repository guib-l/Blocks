...
class ErrorCodeInstall(str,Enum):
    ...
    INSTALL_ERROR_RUN = 'INSTALL_1001'
    INSTALL_ERROR_UPDATE = 'INSTALL_1001'
    INSTALL_ERROR_ENTER = 'INSTALL_1001'
    INSTALL_ERROR_CLOSE = 'INSTALL_1001'
    INSTALL_ERROR_IMPLEMENT = 'INSTALL_1001'
    INSTALL_ERROR_DIFF = 'INSTALL_1001'
...
class ErrorCodeInterface(str,Enum):
    ...
    INTERFACE_ERROR_RUN = 'INTERFACE_1001'
    INTERFACE_ERROR_UPDATE = 'INTERFACE_1001'
    INTERFACE_ERROR_ENTER = 'INTERFACE_1001'
    INTERFACE_ERROR_CLOSE = 'INTERFACE_1001'
    INTERFACE_ERROR_IMPLEMENT = 'INTERFACE_1001'
    INTERFACE_ERROR_DIFF = 'INTERFACE_1001'

class InterfaceError(BaseError):
    """Raised if Interaface is not properly set up with Block."""
    code = ErrorCodeInstall.INTERFACE_ERROR
